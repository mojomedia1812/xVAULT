...
3. Die Datei `plugin.video.xvault-2026.07.27.2.zip` auswählen.
4. xVAULT starten.
...
- LiveTV und LiveTV lite über Senderkategorien oder eigene TV-Favoriten starten.
