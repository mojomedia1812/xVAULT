...
3. Die Datei `plugin.video.xvault-2026.07.17.2.zip` auswaehlen.
4. xVAULT starten.
...
- Optionale xVAULT-Nutzungsstatistik kann in den allgemeinen Einstellungen aktiviert werden. Erfasst werden technische Zaehler wie Installation, Sitzung, grobe System-/Hardwareklasse, Laufzeit-Heartbeat, Navigation, Quellen-/Wiedergabe- und Sync-Events; Titel, Suchbegriffe, Stream-URLs, Zugangsdaten und private Eingaben werden nicht gesendet.
