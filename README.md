...
3. Die Datei `plugin.video.xvault-2026.06.30.1.zip` auswaehlen.
4. xVAULT starten.
...
- Streamquellen fuer Filme und Serien koennen nach bevorzugter Sprache sortiert oder gefiltert werden.
