...
3. Die Datei `plugin.video.xvault-2026.07.17.9.zip` auswaehlen.
4. xVAULT starten.
...
- Die Standard-Aktion wird ueber einen xVAULT-eigenen Auswahl-Dialog gespeichert und migriert alte `hosts.mode.v2`-/`hosts.mode`-/`default.action`-Werte automatisch, damit Kodi-Defaultwerte die Auswahl nicht mehr auf Autoplay zuruecksetzen.
