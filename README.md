...
3. Die Datei `plugin.video.xvault-2026.06.29.6.zip` auswaehlen.
4. xVAULT starten.
...
- LiveTV-Senderliste mit lokalem Cache, Kategorien, Suche, Favoriten, Senderlogos und EPG-Vorschau fuer aktuell laufende und folgende Sendungen.
